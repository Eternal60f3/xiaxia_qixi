...
typewriter
    // .pauseFor(2000)
    .typeText('// This is the love story of Xiaohei and Xiaxia.', classes.comment)
    .pauseNewline()

    .pauseNewline()

    .typeText('hello, xiaxia', classes.method)
    .pauseNewline()
    .typeText('七夕快乐！！！, 这是我们两度过的第一个七夕节啦', classes.method)
    .pauseNewline()
    .typeText('虽然这次有点遗憾，分隔两地了，不过反正过几天你也就要回来了，到时候我们在来一起happy也不迟，哈哈哈', classes.method)
    .pauseNewline()
    .typeText('祝你在未来的每天中都能随心所欲，开开心心地做好自己想做的事情啦', classes.method)
    ...
    .pauseFor(500)
    .typeText('by 小黑', classes.text)
    // .pauseFor(500)
    // .typeText(' xiaxia,', classes.text)
    // .pauseFor(500)
